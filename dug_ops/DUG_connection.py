...
class DUG_connection_object(object):
    ...
    def DUG_proj_name(self):
        ...
        print "The DUG project name is set to : " + str(self.DUG_proj_name)
    ...
    def DUG_project_path(self):
        ...
        print "The DUG project path is set to: " + self.DUG_proj_path
    ...
    def DUG_tape_server_client(self):
        ...
        print "The DUG tape server client is now active .."
